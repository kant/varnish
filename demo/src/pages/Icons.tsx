        ...
        return (
            <React.Fragment>
                ...
                <BodySmall>
                    ...
                    <ExternalLink target="_blank" href="https://ant.design/components/icon/">
                ...
                <SectionWithDivider>
                    ...
                    The Basic Icon includes support for a number of images specified via the{' '}
                    <InlineCode>type</InlineCode> attribute.
                    <br />
                    For a list of icons see the:{' '}
                    <ExternalLink target="_blank" href="https://ant.design/components/icon/">
                        Ant Design Component
                    </ExternalLink>
                ...
                <SectionWithDivider>
                    ...
                    Note that the color WILL NOT be affected by css if the img contains an
                    externally linked SVG.
                    <DefaultLiveProvider code={examples.img} />
                </SectionWithDivider>

                <SectionWithDivider>
                    <h4>Custom SvgIcon</h4>
                    You can pass an inline <InlineCode>SVG</InlineCode> via the{' '}
                    <InlineCode>Svg</InlineCode> attribute. Note that the color WILL be affected by
                    css.
                ...
                <SectionWithDivider>
                    ...
                    affected by css if you use an inline SVG with a{' '}
                    <InlineCode>fill="currentColor"</InlineCode>.
